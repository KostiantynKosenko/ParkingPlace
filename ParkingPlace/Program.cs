...
Car skodovka = new Car("LBT 12 12", "Azure", 4);
Car bavorak = new Car("LBT 13 13", "Purple", 4);
Car peugeot = new Car("LBT 11 11", "Green", 4);
Bus scania = new Bus("LBT 14 14", "Orange", 45);
Tank leopard = new Tank("25", "Grenn");
